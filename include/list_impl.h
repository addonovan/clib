// intentional lack of header guard, see list.h
// for reasons 
...
#ifndef TYPE
  #error "TYPE must be defined before list_impl.h is included"
  #define TYPE int
#endif
...
#else
  #define REF_TYPE const TYPE*
#endif

// we have to know how to postfix the type to make
// unique methods
#ifndef TYPED_NAME
  #error "TYPED_NAME must be defined before list_impl.h is included"
...
#define LIST_METHOD_NAME(method) CONCAT(TYPED_NAME(list), _##method)
#define LIST_NODE_METHOD_NAME(method) CONCAT(TYPED_NAME(list_node), _##method)
